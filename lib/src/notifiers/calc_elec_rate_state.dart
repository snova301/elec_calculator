...
final elecRateTxtCtrVoltProvider = StateProvider((ref) {
  double volt = ref.watch(elecRateProvider).volt;
...
/// 電流
final elecRateTxtCtrCurrentProvider = StateProvider((ref) {
  double current = ref.watch(elecRateProvider).current;
  return TextEditingController(
...
/// 力率
final elecRateTxtCtrCosFaiProvider = StateProvider((ref) {
  double cosFai = ref.watch(elecRateProvider).cosFai;
  return TextEditingController(
...
final elecRateApparentPowerProvider = StateProvider<String>((ref) {
  /// 読み込み
  double power = ref.watch(elecRateProvider).apparentPower;
...
/// 有効電力
final elecRateActivePowerProvider = StateProvider((ref) {
  /// 読み込み
  double power = ref.watch(elecRateProvider).activePower;
  double powerUnitRatio =
      ref.watch(elecRateProvider.notifier).calcPowerUnitRatio();
...
/// 無効電力
final elecRateReactivePowerProvider = StateProvider((ref) {
  /// 読み込み
  double power = ref.watch(elecRateProvider).reactivePower;
  double powerUnitRatio =
      ref.watch(elecRateProvider.notifier).calcPowerUnitRatio();
...
/// sinφ
final elecRateSinFaiProvider = StateProvider((ref) {
  /// 読み込み
  double sinFai = ref.watch(elecRateProvider).sinFai;
